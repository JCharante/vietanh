...
d = DictDB("vietanh", "read")
counter = 0
root = {}
for key in d.getdeflist():
    # if counter > 10:
    #     break
    ...
    for definition in definitions:
        #  # filter out the beginning @ by removing everything before first newline
        #  # definition = ''.join(definition.split('\n')[1:])
        # print word, definition
        root[word]["definitions"].append(definition)
    counter += 1
    print(counter)
